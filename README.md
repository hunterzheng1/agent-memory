...
```bash
python3 scripts/agent_memory_index.py --search "项目 收尾" --limit 5
python3 scripts/agent_memory_index.py --search "偏好" --track user
python3 scripts/agent_memory_index.py --search "复用流程" --memory-type workflow
```
