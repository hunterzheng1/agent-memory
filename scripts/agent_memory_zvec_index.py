...
DEFAULT_EMBEDDING_DIM = int(os.environ.get("AGENT_MEMORY_EMBEDDING_DIM", os.environ.get("CODEX_MEMORY_EMBEDDING_DIM", "768")))
DEFAULT_DEVICE = os.environ.get("AGENT_MEMORY_EMBEDDING_DEVICE", os.environ.get("CODEX_MEMORY_EMBEDDING_DEVICE", "cpu"))
DEFAULT_LIMIT = 5
