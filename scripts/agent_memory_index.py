...
DEFAULT_USER_ID = os.environ.get("AGENT_MEMORY_USER_ID", "demo-user")
DEFAULT_AGENT_ID = os.environ.get("AGENT_MEMORY_AGENT_ID", "codex")
DEFAULT_APP_ID = os.environ.get("AGENT_MEMORY_APP_ID", "codex")
DEFAULT_LIMIT = 5
